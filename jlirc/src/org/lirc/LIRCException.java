/**************************************************************************/
/*
/* LIRCException.java -- Part of the org.lirc package
...
/** Thrown to indicate that an error occured in the communication
	with the lirc daemon.

	@version $Revision: 1.2 $
	@author Bjorn Bringert (bjorn@mumblebee.com)
*/
public class LIRCException extends Exception {
	...
	*/
	public LIRCException(String message) {
		super(message);
	}
