 ...
 * @version 1.0
 */
public class StreamInfoJob extends BaseHDHRJob {
    ...
    public void setProgramId(String s) {
        ...
        programId = s;
        fireJobEvent(JobEvent.UPDATE, "ProgramId: <" + s + ">");
    }
    ...
    public void run() {
        ...
        SystemJob job = SystemJob.getInstance("hdhomerun_config "
            + getId() + " get /tuner" + getTuner() + "/streaminfo");
                        ...
                        for (int i = 0; i < lines.length; i++) {
                            ...
                            if (isProgramLine(lines[i])) {
                                ...
                                if (cindex != -1) {
                                    ...
                                    setProgramId(lines[i].substring(0, cindex));
                                    break;
                                }
                            }
                        }
