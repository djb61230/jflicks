 ...
 * @version 1.0
 */
public class RecordTranscodeJob extends BaseHDHRJob {
     ...
     */
    public RecordTranscodeJob() {
    }

    /**
     * The IP Adress to get video.
     *
    ...
    /**
     * The audio transcode arguments to ffmpeg.
     *
    ...
    /**
     * The program or virtual channel.
     *
     * @return A String instance.
     */
    ...
    public void run() {
        ...
        SystemJob job = SystemJob.getInstance("ffmpeg -y -i "
            + "http://"
            + getIpAddress()
            + ":5004/tuner"
            + getTuner()
    ...
    public void jobUpdate(JobEvent event) {
        ...
        if (event.getType() == JobEvent.COMPLETE) {
            ...
            if (job != null) {
                ...
                fireJobEvent(JobEvent.UPDATE, "RecordTranscodeJob: exit: "
                    + job.getExitValue());
                stop();
            }
        }
