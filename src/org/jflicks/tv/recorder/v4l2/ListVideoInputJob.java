 ...
 * program with the --list-inputs argument to find the video inputs.  It
 * sets a NameValue property that detail these inputs.  Please note that
 * we assume the inputs are reported to us in their proper order by
 * v4l2-ctl.
 *
 * @author Doug Barnum
 * @version 1.0
...
public class ListVideoInputJob extends BaseV4l2Job {
     ...
     */
    public ListVideoInputJob() {
    }

    /**
     * The information about video inputs for any particular v4l2 device
     * is encapsulated in a NameValue instance.
     *
            ...
            if (job != null) {
                ...
                if (output != null) {
                    ...
                    if (array != null) {
                        ...
                        nv.setName(NMSConstants.VIDEO_INPUT_NAME);
                        nv.setDescription(NMSConstants.VIDEO_INPUT_NAME);
