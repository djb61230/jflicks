 ...
 * @version 1.0
 */
public class ComSilentBlackWorker extends BaseWorker implements JobListener {
    ...
    public void work(Recording r) {
        ...
        if (r != null) {
            ...
            ComSilentBlackJob job = new ComSilentBlackJob(r, this);
    ...
    public void jobUpdate(JobEvent event) {
        ...
        if (event.getType() == JobEvent.COMPLETE) {
            ...
            LogUtil.log(LogUtil.INFO, "ComSilentBlackWorker: completed");
            ComSilentBlackJob job = (ComSilentBlackJob) event.getSource();
            removeJobContainer(job);
            fireWorkerEvent(WorkerEvent.COMPLETE, job.getRecording(), true);

        } else {

            //LogUtil.log(LogUtil.DEBUG, "ComSilentBlackWorker: " + event.getMessage());
        }
    }
