...
/**
 * Simple activater that starts our themoviedb service.
 *
 * @author Doug Barnum
 * @version 1.0
 */
public class Activator extends BaseActivator {
    ...
    public void start(BundleContext bc) {
        ...
        setBundleContext(bc);
        TheMovieDBMetadata m = new TheMovieDBMetadata();
        setTheMovieDBMetadata(m);
    ...
    private TheMovieDBMetadata getTheMovieDBMetadata() {
        return (theMovieDBMetadata);
    }

    private void setTheMovieDBMetadata(TheMovieDBMetadata m) {
        theMovieDBMetadata = m;
    }
