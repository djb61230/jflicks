...
public class DisplayRecordingPanel extends JPanel
     ...
     * Empty constructor.
     */
    public DisplayRecordingPanel(SchedulerPanel p) {
    ...
    class StopAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            RecordingPanel rp = getRecordingPanel();
            SchedulerPanel sp = getSchedulerPanel();
            if ((sp != null) && (rp != null)) {
    ...
    class DeleteAction extends AbstractAction {
        ...
        public DeleteAction() {
            ...
            ImageIcon sm = new ImageIcon(getClass().getResource("delete16.png"));
            ImageIcon lge = new ImageIcon(getClass().getResource("delete32.png"));
