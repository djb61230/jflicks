...
/**
 * Simple activator that creates a EZView and starts it.  Also registers
 * the EZView so a Controller can find it.
 *
 * @author Doug Barnum
 * @version 1.0
 */
public class Activator extends BaseActivator {
    ...
    public void start(BundleContext bc) {
        ...
        dict.put(EZView.TITLE_PROPERTY, "JFLICKS-EZCONFIGCLIENT");
