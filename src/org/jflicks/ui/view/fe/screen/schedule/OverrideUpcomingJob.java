 ...
 * @version 1.0
 */
public class OverrideUpcomingJob extends AbstractJob {
     ...
     * @param u An Upcoming to override.
     */
    public OverrideUpcomingJob(NMS nms, Upcoming u) {
    ...
    private Upcoming getUpcoming() {
        return (upcoming);
    }

    private void setUpcoming(Upcoming u) {
        upcoming = u;
    }
