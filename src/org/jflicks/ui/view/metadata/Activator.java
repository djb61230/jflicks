...
/**
 * Simple activator that creates a MetadataView and starts it.  Also registers
 * the MetadataView so a Controller can find it.
 *
 * @author Doug Barnum
 * @version 1.0
 */
public class Activator extends BaseActivator {
    ...
    public void start(BundleContext bc) {
        ...
        MetadataView v = new MetadataView();
        ...
        dict.put(MetadataView.TITLE_PROPERTY, "JFLICKS-METADATA");
