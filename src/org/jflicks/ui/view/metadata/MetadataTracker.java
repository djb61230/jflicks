...
public class MetadataTracker extends BaseTracker {
     ...
     */
    public MetadataTracker(BundleContext bc, MetadataView v) {

        super(bc, Metadata.class.getName());
        setMetadataView(v);
    }

    private MetadataView getMetadataView() {
        return (metadataView);
    }

    private void setMetadataView(MetadataView v) {
        metadataView = v;
    }
    ...
    public Object addingService(ServiceReference sr) {
        ...
        MetadataView v = getMetadataView();
        if ((bc != null) && (v != null)) {
