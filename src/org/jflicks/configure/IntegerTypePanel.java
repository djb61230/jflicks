 ...
 * @version 1.0
 */
public class IntegerTypePanel extends BaseTypePanel {
     ...
     */
    public IntegerTypePanel(NameValue nv) {
        ...
        if (nv != null) {
            ...
            if ((nv.getMin() != Integer.MIN_VALUE)
                && (nv.getMax() != Integer.MAX_VALUE)
                && (nv.getStep() != Integer.MIN_VALUE)) {

                SpinnerNumberModel model =
                    new SpinnerNumberModel(Util.str2int(nv.getValue(), 0),
                    nv.getMin(), nv.getMax(), nv.getStep());
                JSpinner spin = new JSpinner(model);
                setValueSpinner(spin);
                comp = spin;
    ...
    private void setValueSpinner(JSpinner s) {
        valueSpinner = s;
    }
