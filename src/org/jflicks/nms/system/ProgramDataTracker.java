 ...
 * @version 1.0
 */
public class ProgramDataTracker extends BaseTracker {
     ...
     */
    public ProgramDataTracker(BundleContext bc, SystemNMS nms) {

        super(bc, ProgramData.class.getName());
        setSystemNMS(nms);
    }
    ...
    /**
     * A new ProgramData service has come online.
     *
    ...
    public Object addingService(ServiceReference sr) {
        ...
        if ((bc != null) && (s != null)) {
            ...
            ProgramData service = (ProgramData) bc.getService(sr);
            s.addProgramData(service);
            result = service;
        }
     ...
     *
     * @param sr The ProgramData ServiceReference.
     * @param svc The ProgramData instance.
     */
    ...
    public void removedService(ServiceReference sr, Object svc) {
        ...
        if (s != null) {
            ...
            s.removeProgramData((ProgramData) svc);
        }
    }
