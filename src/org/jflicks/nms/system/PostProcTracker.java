...
/**
 * A tracker for the postproc service.
 *
 * @author Doug Barnum
 * @version 1.0
 */
public class PostProcTracker extends BaseTracker {
     ...
     */
    public PostProcTracker(BundleContext bc, SystemNMS nms) {

        super(bc, PostProc.class.getName());
        setSystemNMS(nms);
    }
    ...
    /**
     * A new PostProc service has come online.
     *
    ...
    public Object addingService(ServiceReference sr) {
        ...
        if ((bc != null) && (s != null)) {
            ...
            PostProc service = (PostProc) bc.getService(sr);
            s.setPostProc(service);
            result = service;
        }
     ...
     *
     * @param sr The PostProc ServiceReference.
     * @param svc The PostProc instance.
     */
