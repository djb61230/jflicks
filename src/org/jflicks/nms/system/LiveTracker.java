 ...
 * @version 1.0
 */
public class LiveTracker extends BaseTracker {
     ...
     */
    public LiveTracker(BundleContext bc, SystemNMS nms) {

        super(bc, Live.class.getName());
        setSystemNMS(nms);
    }
    ...
    /**
     * A new Live service has come online.
     *
    ...
    public Object addingService(ServiceReference sr) {
        ...
        if ((bc != null) && (s != null)) {
            ...
            Live service = (Live) bc.getService(sr);
            s.setLive(service);
            result = service;
        }
