 ...
 * @version 1.0
 */
public class AutoArtTracker extends BaseTracker {
     ...
     */
    public AutoArtTracker(BundleContext bc, SystemNMS nms) {

        super(bc, AutoArt.class.getName());
        setSystemNMS(nms);
    }
    ...
    public Object addingService(ServiceReference sr) {
        ...
        if ((bc != null) && (s != null)) {
            ...
            AutoArt service = (AutoArt) bc.getService(sr);
            s.setAutoArt(service);
            result = service;
        }
