...
/**
 * A tracker for the OnDemand service.
 *
 * @author Doug Barnum
 * @version 1.0
 */
public class OnDemandTracker extends BaseTracker {
     ...
     */
    public OnDemandTracker(BundleContext bc, SystemNMS nms) {

        super(bc, OnDemand.class.getName());
        setSystemNMS(nms);
    }
    ...
    public Object addingService(ServiceReference sr) {
        ...
        if ((bc != null) && (s != null)) {
            ...
            OnDemand service = (OnDemand) bc.getService(sr);
            s.addOnDemand(service);
            result = service;
        }
