...
/**
 * A tracker for the trailer service.
 *
 * @author Doug Barnum
 * @version 1.0
 */
public class TrailerTracker extends BaseTracker {
     ...
     */
    public TrailerTracker(BundleContext bc, SystemNMS nms) {

        super(bc, Trailer.class.getName());
        setSystemNMS(nms);
    }
    ...
    public Object addingService(ServiceReference sr) {
        ...
        if ((bc != null) && (s != null)) {
            ...
            Trailer service = (Trailer) bc.getService(sr);
            s.addTrailer(service);
            result = service;
        }
