 ...
 * @version 1.0
 */
public class RecorderTracker extends BaseTracker {
     ...
     */
    public RecorderTracker(BundleContext bc, SystemNMS nms) {

        super(bc, Recorder.class.getName());
        setSystemNMS(nms);
    }
    ...
    public Object addingService(ServiceReference sr) {
        ...
        if ((bc != null) && (s != null)) {
            ...
            Recorder service = (Recorder) bc.getService(sr);
            s.addRecorder(service);
            result = service;
        }
