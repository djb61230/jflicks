...
/**
 * A tracker for the live service.
 *
 * @author Doug Barnum
 * @version 1.0
 */
public class CleanerTracker extends BaseTracker {
     ...
     */
    public CleanerTracker(BundleContext bc, SystemNMS nms) {

        super(bc, Cleaner.class.getName());
        setSystemNMS(nms);
    }
    ...
    /**
     * A new Cleaner service has come online.
     *
    ...
    public Object addingService(ServiceReference sr) {
        ...
        if ((bc != null) && (s != null)) {
            ...
            Cleaner service = (Cleaner) bc.getService(sr);
            s.setCleaner(service);
            result = service;
        }
     ...
     *
     * @param sr The Cleaner ServiceReference.
     * @param svc The Cleaner instance.
     */
